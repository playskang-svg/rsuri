...
export const generateWikiKeywordPage = (
  ...
  const koreanMasterNames: {
    ...
    { name: '정우진 마스터', shop: `${region.neighborhood} 스마트홈 집수리`, exp: '설비기능장 (16년 경력)', phone: '010-4684-8838', grade: '설비기능장' },
    { name: '김태호 주임기사', shop: `${region.cityDistrict} 스피드 홈닥터`, exp: '1급 시공기사 (11년 경력)', phone: '010-4684-8838', grade: '1급 시공기사' },
    { name: '최민수 기술소장', shop: `${region.neighborhood} 정밀누수설비`, exp: '누수탐지명장 (19년 경력)', phone: '010-4684-8838', grade: '수리위키 인증명장' },
  ];
